...
const EarringsPage = () => {
  const { data: products, isLoading } = useProducts("earrings");
    ...
    <Layout>
      <section className="relative h-[50vh] min-h-[400px] flex items-center justify-center pt-20">
        ...
        <AnimatedSection className="relative z-10 text-center text-primary-foreground">
          <h1 className="font-serif text-5xl md:text-6xl mb-4">Earrings</h1>
          <p className="text-lg opacity-90 max-w-md mx-auto">
            Elegant earrings to complement your style
          </p>
        </AnimatedSection>
      </section>
